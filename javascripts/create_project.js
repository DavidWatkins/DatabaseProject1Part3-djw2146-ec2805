...
<p>\
<input type=\"text\" name='PLName'" + link_count.toString() + "' id='PLName'" + link_count.toString() + "' placeholder='Website Name' />\
        </p>\
<p>\
<input type=\"text\" name='PLURL'" + link_count.toString() + "' id='PLName'" + link_count.toString() + "'  placeholder='Website URL' />\
        </p>\
        </div>";
